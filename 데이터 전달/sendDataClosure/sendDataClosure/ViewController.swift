...
class ViewController: UIViewController {
    ...
    @objc func rightBarButtonTapped() {
        ...
        controller.plusCompletionButtonAction = { text in
            print("receive data: \(text)")
            self.memoArr.append(text)
        }
        
        print("go pushViewController")
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.editButtonAction = { [weak self] text in
            let controller = EditController()
            //controller.memoArrString = text
            controller.editMemoTextView.text = text
            
            controller.editCompletionButtonAction = { text in
                self?.memoArr[indexPath.row] = text
            }
